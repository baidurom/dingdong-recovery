...
#define CUST_EINT_HALL_NUM              74
#define CUST_EINT_HALL_DEBOUNCE_CN      128
#define CUST_EINT_HALL_POLARITY         CUST_EINT_POLARITY_LOW
#define CUST_EINT_HALL_SENSITIVE        CUST_EINT_LEVEL_SENSITIVE
#define CUST_EINT_HALL_DEBOUNCE_EN      CUST_EINT_DEBOUNCE_ENABLE

#define CUST_EINT_MHL_NUM              129
#define CUST_EINT_MHL_DEBOUNCE_CN      3
#define CUST_EINT_MHL_POLARITY         CUST_EINT_POLARITY_LOW
#define CUST_EINT_MHL_SENSITIVE        CUST_EINT_EDGE_SENSITIVE
