...
/* Vanzo:songlixin on: Thu, 18 Aug 2011 17:43:57 +0800
 * For Psensor
 */
...
extern "C"
{
	...
	/* Vanzo:songlixin on: Thu, 18 Aug 2011 17:58:05 +0800
	 * For Psensor Clibration
	 */

	{ "/data/nvram/APCFG/APRDEB/PSENSOR",         VER(AP_CFG_CUSTOM_FILE_PSENSOR_LID),            CFG_FILE_PSENSOR_REC_SIZE,
	  CFG_FILE_PSENSOR_REC_TOTAL,                  SIGNLE_DEFUALT_REC,                (char *)&stPsensorDefault, DataReset , NULL},
	{ "/data/nvram/APCFG/APRDEB/SALESREGFLAG",         VER(AP_CFG_CUSTOM_FILE_SALESREGFLAG_LID),              CFG_FILE_SALESREGFLAG_REC_SIZE,
	  CFG_FILE_SALESREGFLAG_REC_TOTAL,                  SIGNLE_DEFUALT_REC,                (char *)&stSalesregflagDefault, DataReset , NULL},
	{ "/data/nvram/APCFG/APRDEB/MODEL",         VER(AP_CFG_CUSTOM_FILE_MODEL_LID),            CFG_FILE_MODEL_REC_SIZE,
	  CFG_FILE_MODEL_REC_TOTAL,                  SIGNLE_DEFUALT_REC,                (char *)&stModelDefault, DataReset , NULL},
	// End of Vanzo:songlixin
    };
