...
/* Vanzo:songlixin on: Thu, 18 Aug 2011 18:10:31 +0800
 * For psensor
 */
LID_BIT VER_LID(AP_CFG_CUSTOM_FILE_PSENSOR_LID)
      File_Psensor_Struct *CFG_FILE_PSENSOR_REC_TOTAL
{

};

LID_BIT VER_LID(AP_CFG_CUSTOM_FILE_SALESREGFLAG_LID)
      File_Salesregflag_Struct *CFG_FILE_SALESREGFLAG_REC_TOTAL
{

};

LID_BIT VER_LID(AP_CFG_CUSTOM_FILE_MODEL_LID)
      File_Model_Struct *CFG_FILE_MODEL_REC_TOTAL
{
