...
static void init_lcm_registers(void)
{
	...
	nt35590_DCS_write_1A_1P(0x26, 0x08);
	nt35590_DCS_write_1A_1P(0x26, 0x00);
	...
	nt35590_DCS_write_1A_1P(0x0E, 0x33);
	nt35590_DCS_write_1A_1P(0x11, 0x7D);
	...
	nt35590_DCS_write_1A_1P(0x22, 0x11);
	...
	nt35590_DCS_write_1A_1P(0x28, 0x00);
	...
	nt35590_DCS_write_1A_1P(0xFF, 0x00);
	nt35590_DCS_write_1A_1P(0xFB, 0x01);
	nt35590_DCS_write_1A_1P(0xBA, 0x03);
#if (LCM_DSI_CMD_MODE)
