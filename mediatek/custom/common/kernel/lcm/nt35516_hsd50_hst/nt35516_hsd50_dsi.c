...
data_array[0]=0x00063902;
	...
	data_array[0]=0x00043902;
	data_array[1]=0x00B000BD;
	dsi_set_cmdq(&data_array,2,1);

	data_array[0]=0x00C11500;
	dsi_set_cmdq(&data_array,1,1);

	data_array[0]=0x46BE1500;
	dsi_set_cmdq(&data_array,1,1);
...
//#Gamma Setting
	...
	data_array[2]=0x00900062;
	data_array[3]=0x00C500AE;
	data_array[4]=0x010701EA;
	data_array[5]=0x00000034;
	dsi_set_cmdq(&data_array,6,1);

	data_array[0]=0x00173902;
	data_array[1]=0x015801D2;
	data_array[2]=0x01BB018F;
	data_array[3]=0x023702FF;
	data_array[4]=0x026E0239;
	data_array[5]=0x000000A9;
	dsi_set_cmdq(&data_array,6,1);

	data_array[0]=0x00173902;
	data_array[1]=0x03D002D3;
	data_array[2]=0x032C0307;
	data_array[3]=0x0381035F;
	data_array[4]=0x03C303AC;
	data_array[5]=0x000000DD;
	dsi_set_cmdq(&data_array,6,1);

	data_array[0]=0x00053902;
	data_array[1]=0x03F603D4;
...
//////////PAGE 0
	...
	data_array[0]=0x00053902;
	data_array[1]=0x050601B8;
	data_array[2]=0x00000004;
	dsi_set_cmdq(&data_array,3,1);

	data_array[0]=0x55BB1500;
	dsi_set_cmdq(&data_array,1,1);
