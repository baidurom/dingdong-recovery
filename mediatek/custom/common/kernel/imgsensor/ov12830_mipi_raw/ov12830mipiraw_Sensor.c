...
static struct OV12830_SENSOR_STRUCT OV12830_sensor=
{
        .i2c_write_id = 0x6c,
        .i2c_read_id  = 0x6d,
};
...
//#define OV12830_write_cmos_sensor(addr, para) iWriteReg((u16) addr , (u32) para , 1, OV12830_sensor.i2c_write_id)
int OV12830_write_cmos_sensor(u16 addr, u32 para)
{
  return  iWriteReg((u16) addr , (u32) para , 1, OV12830_sensor.i2c_write_id);
}
#define OV12830_multi_write_cmos_sensor(pData, lens) iMultiWriteReg((u8*) pData, (u16) lens, OV12830_sensor.i2c_write_id)


kal_uint16 OV12830_read_cmos_sensor(kal_uint32 addr)
{
kal_uint16 get_byte=0;
    iReadReg((u16) addr ,(u8*)&get_byte,OV12830_sensor.i2c_write_id);
    return get_byte;
}
...
UINT32 OV12830Open(void)
{
	...
	OV12830_Sensor_Init();
/*
        OV12830_write_cmos_sensor(0x0100,0x01);// wake up//add for ensure can enter otp
        mDELAY(50);
        otp_update_wb(0x165, 0x13f);
        otp_update_lenc();
        otp_update_BLC();
*/
        spin_lock(&ov12830mipiraw_drv_lock);
...
static bool Sensorid_has_get = 0;
UINT32 OV12830GetSensorID(UINT32 *sensorID)
{
    int  retry = 1;
    if(Sensorid_has_get == 1)
    {
        *sensorID = OV12830_SENSOR_ID;
    ...
    if (*sensorID != OV12830_SENSOR_ID) {
        OV12830_sensor.i2c_write_id = 0x20;
        OV12830_write_cmos_sensor(0x0103,0x01);// Reset sensor
        mDELAY(10);
        // check if sensor ID correct
        do {
	...
	OV12830DB("OV12830GetSensorID end :\n ");
