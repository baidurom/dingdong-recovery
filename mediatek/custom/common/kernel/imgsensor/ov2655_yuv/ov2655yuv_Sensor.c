...
UINT32 OV2655GetResolution(MSDK_SENSOR_RESOLUTION_INFO_STRUCT *pSensorResolution)
{
	...
	pSensorResolution->SensorVideoWidth=OV2655_IMAGE_SENSOR_PV_WIDTH - 2 * IMAGE_SENSOR_START_GRAB_X -8;
	pSensorResolution->SensorVideoHeight=OV2655_IMAGE_SENSOR_PV_HEIGHT - 2 * IMAGE_SENSOR_START_GRAB_Y -6;
	return ERROR_NONE;
}	/* OV2655GetResolution() */
