...
#define __HWMSEN_CUSTOM_H__
	...
	#define ACCELEROMETER 		"LIS3dh 3-axis Accelerometer"
	#define ACCELEROMETER_VENDER 	"ST"
#endif

#ifdef CUSTOM_KERNEL_ALSPS
	#define PROXIMITY 		"TMD2772  Proximity Sensor"
	#define PROXIMITY_VENDER 	"TOAS"
	#define LIGHT 			"TMD2772 Light Sensor"
	#define LIGHT_VENDER 		"TOAS"
#endif
