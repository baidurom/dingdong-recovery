...
#CUSTOM_KERNEL_WIFI = 
#CUSTOM_MODEM = huaqin89_we_jb2_md1_hspa_G4W3
#DOLBY_AUDIOEFFECT_DM = true
#DOLBY_DDPDEC51 = true
#DOLBY_DDPDEC51_PORTABLEMODE = true
#HAVE_AEE_FEATURE = no
#HQ_BANDMODE_2AND1 = yes
#HQ_BANDMODE_3AND2 = yes
#MTK_DT_SUPPORT = yes
...
BUILD_UBOOT = no
CUSTOM_BUILD_VERNO = 
CUSTOM_EXIF_STRING_MAKE = "YUANDIAN"
CUSTOM_EXIF_STRING_MODEL = "YUANDIAN"
...
CUSTOM_HAL_IMGSENSOR = ov12830_mipi_raw_truly ov5648_mipi_raw a5142_mipi_raw
CUSTOM_HAL_LENS = ov12830af dummy_lens dummy_lens
CUSTOM_HAL_MAIN2_IMGSENSOR = 
CUSTOM_HAL_MAIN_BACKUP_IMGSENSOR = 
CUSTOM_HAL_MAIN_BACKUP_LENS = dummy_lens #fm50af
CUSTOM_HAL_MAIN_IMGSENSOR = ov12830_mipi_raw_truly
CUSTOM_HAL_MAIN_LENS = ov12830af
CUSTOM_HAL_MSENSORLIB = mmc328x akm8975 ami304 yamaha530 mag3110 akm8963 bmm050 mmc3416x
CUSTOM_HAL_SENSORS = sensor
CUSTOM_HAL_SUB_BACKUP_IMGSENSOR = a5142_mipi_raw
CUSTOM_HAL_SUB_BACKUP_LENS = dummy_lens
CUSTOM_HAL_SUB_IMGSENSOR = ov5648_mipi_raw
CUSTOM_HAL_SUB_LENS = dummy_lens
CUSTOM_KERNEL_ACCELEROMETER = lis3dh kxtik1004
CUSTOM_KERNEL_ALSPS = ap3216c #tmd2771 APDS9930
CUSTOM_KERNEL_BATTERY = battery
CUSTOM_KERNEL_BREATHLED = aw9136
CUSTOM_KERNEL_CAMERA = camera
CUSTOM_KERNEL_CAM_CAL = dummy_eeprom
CUSTOM_KERNEL_CODEC = wm8958
...
CUSTOM_KERNEL_IMGSENSOR = ov12830_mipi_raw_truly ov5648_mipi_raw a5142_mipi_raw
CUSTOM_KERNEL_KPD = kpd
CUSTOM_KERNEL_LCM = nt35596_fhd_dsi_vdo_truly r63315_fhd_dsi_vdo
CUSTOM_KERNEL_LEDS = mt65xx
CUSTOM_KERNEL_LENS = ov12830af dummy_lens dummy_lens
CUSTOM_KERNEL_MAGNETOMETER = akm8963
CUSTOM_KERNEL_MAIN2_BACKUP_IMGSENSOR = 
CUSTOM_KERNEL_MAIN2_IMGSENSOR = 
CUSTOM_KERNEL_MAIN_BACKUP_IMGSENSOR = 
CUSTOM_KERNEL_MAIN_BACKUP_LENS = dummy_lens#fm50af
CUSTOM_KERNEL_MAIN_IMGSENSOR = ov12830_mipi_raw_truly
CUSTOM_KERNEL_MAIN_LENS = ov12830af
CUSTOM_KERNEL_RTC = rtc
CUSTOM_KERNEL_SOUND = amp_aw8145
CUSTOM_KERNEL_SSW = ssw_generic
CUSTOM_KERNEL_SUB_BACKUP_IMGSENSOR = a5142_mipi_raw
CUSTOM_KERNEL_SUB_BACKUP_LENS = dummy_lens
CUSTOM_KERNEL_SUB_IMGSENSOR = ov5648_mipi_raw
CUSTOM_KERNEL_SUB_LENS = dummy_lens
CUSTOM_KERNEL_TOUCHPANEL = GT9XX_a818 #cy8ctma300 GT818B-fpga
CUSTOM_KERNEL_USB = mt6577
CUSTOM_KERNEL_VIBRATOR = vibrator
CUSTOM_LK_LCM = nt35596_fhd_dsi_vdo_truly r63315_fhd_dsi_vdo
#CUSTOM_MODEM = A818_G3W2_huaqin89_we_jb2_md1_hspa_V6_P15
CUSTOM_PRELOADER_CUSTOM = custom
CUSTOM_SEC_AUTH_SUPPORT = no
CUSTOM_SEC_SIGNTOOL_SUPPORT = no
CUSTOM_UBOOT_LCM = nt35596_fhd_dsi_vdo_truly r63315_fhd_dsi_vdo
...
HQ_4TABS_DIALPAD_STYLE_SUPPORT = yes
HQ_ADD_GLOBAL_REBOOT = yes
HQ_APP_DOLBY_CONTROL = no
HQ_APP_MUSIC_PIONEER = no
HQ_AUDIOPROFILE_CHANGE_BY_VOLUMEKEY_FORBIDDEN = no
HQ_AW9136_LED = yes
HQ_BATFULL_AFTER_45MIN = yes
HQ_BICR_RES_CUSTOM = yes
HQ_BOOT_WITH_VIBRATOR = yes
HQ_BREATHLIGHT_SUPPORT = yes
HQ_BT_NAME = YUANDIAN
HQ_CALL_SETTINGS_SUPPORT = yes
HQ_CAMERA_ANTIBANDING_DEFAULT = yes
HQ_CLIENT_ADB = yes
HQ_CONTACTS_CALLLOG_DETAIL_USE_ICON = no
HQ_CONTACTS_SUPPORT_DUAL_CARD_DIAL = no
HQ_CONTACT_BADGE_OVERLAY_UNSUPPORT = yes
HQ_CONTACT_IMPORT_COMBINE_ONCE = yes
HQ_COPY_TO_SIM_CUT_OUT_SUPPORT = yes
HQ_CUSTOM_LOCKSCREEN_SUPPORT = yes
HQ_CUSTOM_SW_VERSION_REMOVE = yes
HQ_DEFAULT_ALARM_ALERT = Argon.ogg
HQ_DEFAULT_LAUNCHER_SUPPORT = yes
HQ_DEFAULT_NOTIFICATION = Tambourine.mp3
HQ_DEFAULT_RINGTONE = 001_Aries.mp3
HQ_DEFAULT_STANDARD_RATIO = yes
HQ_DEL_SCHEDULEPOWERONOFF = yes
HQ_DESKCLOCK_ICON_SUPPORT = no
HQ_DESKCLOCK_SUPPORT = yes
HQ_DISABLE_CUSTOM_AUDIO_PROFILE = yes
HQ_DISABLE_SUNING_SIM_COLOR = yes
HQ_DISPLAY_MAGNIFICATION_UNSUPPORTED = yes
HQ_DOUBLE_LOCKSCREEN_SUPPORT = yes
HQ_DO_NOT_RESET_WHEN_NO_BATTERY = yes
HQ_EXTERNAL_SDCARD_UNMOUNT = yes
HQ_FIREWALL_BLOCK_SUPPORT = no
HQ_FLASHLIGHT_APP = yes
HQ_FMRADIO_SUPPORT = no
HQ_FORCE_CONTINUES_SHOT_FLASH_ON = yes
HQ_INCALL_ATTENTION_LIGHT_SUPPORT = yes
HQ_IPO_SETTING_REMOVE = yes
HQ_LAUNCHER2_UNSUPPORT = yes
HQ_LAUNCHER_SUNING_APP = no
HQ_LAUNCHER_UPGRADE_UNSUPPORT = yes
HQ_MMS_LOCATION_SUPPORT = no
HQ_NOXUS_DEVSTORSER_DIALOGSTYLE = yes
HQ_NOXUS_LAUNCHER_PERFERED = no
HQ_NOXUS_NO_RESTART_DIALOG = yes
HQ_NOXUS_POWER_OFF_CHARGE = yes
HQ_NOXUS_RINGTONE = yes
HQ_NOXUS_SCREEN_LOCK_SUPPORT = yes
HQ_NOXUS_SDCARD_NOSUPPORT = yes
HQ_NOXUS_SEARCH_ENGINE_BAIDU = yes
HQ_NOXUS_SWITCH_STYLE = yes
HQ_NOXUS_VIBRATOR_FEEDBACK_SUPPORT = yes
HQ_NOXUS_VOLUMEPANEL_BACKGROUND = yes
HQ_NOXUS_WIFI_NOTIFICATION_SOUND = yes
HQ_PHONE_VIBRATE_CONTROL = yes
HQ_POWER_OFF_DIRECTLY = yes
HQ_PRODUCT_DEVICE = YUANDIAN
HQ_PRODUCT_NAME = YUANDIAN
HQ_PROJECT_A811 = yes
HQ_PROJECT_A811_SUNING = no
HQ_PROJECT_A818 = yes
HQ_PROJECT_VERSION = ChangeOS_1_Release_1.1.0
HQ_QUICK_LAUNCH_CAMERA_SUPPORT = yes
HQ_REMOVE_15PAR_TRACKING_POINT = yes
HQ_REMOVE_TEMPRATURE_PROTECT = no
HQ_RM_SCREENSAVER = yes
HQ_RM_WIFIDISPLAY = yes
HQ_SDCARD_UPGRADE_SUPPORT = yes
HQ_SETTINGHQ_NOXUS_APP_BATTERY_DISPLAY = yes
HQ_SETTINGS_SUPPORT = yes
HQ_SHUTOFFANIMATION_SUPPORT = yes
HQ_SINGLE_SIM = yes
HQ_SMS_FORWARD_WITH_SENDER = no
HQ_THEME_LIGHT_DIALOG_SUPPORT = yes
HQ_TTS_SETTINGS_REMOVE = yes
HQ_TURN_OFF_CHARGER_GETBATV = no
HQ_USB_MANUFACTURER_NAME = "YUANDIAN^Incorporated"
HQ_USB_MS_PRODUCT = "YUANDIAN"
HQ_USB_MS_VENDOR = "YUANDIAN"
HQ_USB_PRODUCT_NAME = "YUANDIAN^Incorporated^GSM^Handset"
HQ_USE_EXT_CODEC = no
HQ_USING_HQFTM = yes
HQ_WIFI_LEVEL_NOXUS_CUSTOM = yes
...
MTK_BT_SUPPORT = yes
MTK_BUILD_VERNO = ChangeOS_1_Release_1.1.0
MTK_BWC_SUPPORT = yes
...
MTK_PRODUCT_LOCALES = zh_CN en_US xxhdpi xhdpi hdpi mdpi
...
NOXUS_ACTIONBAR_STYLE = yes
NOXUS_ADD_SUBTITLE = yes
NOXUS_CAMERA_SUPPORT = yes
NOXUS_DATA_STATISTICS = yes
NOXUS_POWEROFF_MENU = yes
NOXUS_SYSTEM_UI_SUPPORT = yes
...
PRODUCT_BOARD = YUANDIAN
PRODUCT_BRAND = YUANDIAN
PRODUCT_MANUFACTURER = YUANDIAN
PRODUCT_MODEL = YUANDIAN
RESOURCE_OVERLAY_SUPPORT = generic
RO_CONFIG_CUSTLOCKCNAME = cn.noxus.theme.LockScreenDelegate
RO_CONFIG_CUSTLOCKPNAME = cn.noxus.theme
RO_CONFIG_DEF_LAUNCHER_CNAME = cn.noxus.launcher.Launcher
RO_CONFIG_DEF_LAUNCHER_PNAME = cn.noxus.launcher
RO_CONFIG_VIBRATE_CONTROL = 1
