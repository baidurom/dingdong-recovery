...
#define PMIC_TOP_CKCON2           (PMIC_BASE+0x0066)
...
#define PWRAPERR(fmt, arg...)   printf(PWRAPTAG "ERROR,%5d: "fmt, __LINE__, ##arg)
#define PWRAPREG(fmt, arg...)   printf(PWRAPTAG "%5d: "fmt,##arg)
