...
U32 pmic6320_init (void)
{
    ...
    pmic_config_interface(DIGLDO_CON12, 1,PMIC_RG_VGP6_EN_MASK,PMIC_RG_VGP6_EN_SHIFT);
    pmic_config_interface(DIGLDO_CON33,6,PMIC_RG_VGP6_VOSEL_MASK,PMIC_RG_VGP6_VOSEL_SHIFT);
#endif
