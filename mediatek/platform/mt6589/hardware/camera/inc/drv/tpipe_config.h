...
typedef struct ISP_TPIPE_CONFIG_VIPI_STRUCT
{
    ...
    int vipi_xsize; /* byte size - 1 */
    int vipi_ysize; /* byte size - 1 */
...
typedef struct ISP_TPIPE_CONFIG_DISPO_STRUCT
{
    ...
    int dispo_stride_v;
    int dispo_crop_en;
    int dispo_xsize; /* pixel size */
    int dispo_ysize; /* pixel size */
