...
{
    mt_irq_set_sens(MT_MFG_IRQ0_ID, MT_LEVEL_SENSITIVE);
    mt_irq_set_polarity(MT_MFG_IRQ0_ID, MT_POLARITY_LOW);

    mt_irq_set_sens(MT_MFG_IRQ1_ID, MT_LEVEL_SENSITIVE);
    mt_irq_set_polarity(MT_MFG_IRQ1_ID, MT_POLARITY_LOW);

    mt_irq_set_sens(MT_MFG_IRQ2_ID, MT_LEVEL_SENSITIVE);
    mt_irq_set_polarity(MT_MFG_IRQ2_ID, MT_POLARITY_LOW);

    mt_irq_set_sens(MT_MFG_IRQ3_ID, MT_LEVEL_SENSITIVE);
    mt_irq_set_polarity(MT_MFG_IRQ3_ID, MT_POLARITY_LOW);

    mt_irq_set_sens(MT_MFG_IRQ4_ID, MT_LEVEL_SENSITIVE);
    mt_irq_set_polarity(MT_MFG_IRQ4_ID, MT_POLARITY_LOW);

    mt_irq_set_sens(MT_MFG_IRQ5_ID, MT_LEVEL_SENSITIVE);
    mt_irq_set_polarity(MT_MFG_IRQ5_ID, MT_POLARITY_LOW);
    
    mt_irq_set_sens(MT_MFG_IRQ6_ID, MT_LEVEL_SENSITIVE);
    mt_irq_set_polarity(MT_MFG_IRQ6_ID, MT_POLARITY_LOW);

    mt_irq_set_sens(MT_MFG_IRQ7_ID, MT_LEVEL_SENSITIVE);
    mt_irq_set_polarity(MT_MFG_IRQ7_ID, MT_POLARITY_LOW);

    mt_irq_set_sens(MT_MFG_IRQ8_ID, MT_LEVEL_SENSITIVE);
    mt_irq_set_polarity(MT_MFG_IRQ8_ID, MT_POLARITY_LOW);

    mt_irq_set_sens(MT_MFG_IRQ9_ID, MT_LEVEL_SENSITIVE);
    mt_irq_set_polarity(MT_MFG_IRQ9_ID, MT_POLARITY_LOW);

    mt_irq_set_sens(MT_MFG_IRQ10_ID, MT_LEVEL_SENSITIVE);
    mt_irq_set_polarity(MT_MFG_IRQ10_ID, MT_POLARITY_LOW);
