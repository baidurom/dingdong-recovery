...
typedef struct
{
	unsigned DPI_CHKSUM      : 24;
    unsigned rsv_1           : 6;
    unsigned DPI_CHKSUM_READY  : 1;
    unsigned DPI_CHKSUM_EN     : 1;
...
STATIC_ASSERT(0x0030 == offsetof(DPI_REGS, BG_HCNTL));
STATIC_ASSERT(0x0040 == offsetof(DPI_REGS, STATUS));
STATIC_ASSERT(0x004c == offsetof(DPI_REGS, PATTERN));
#endif
#ifdef __cplusplus
}
#endif
