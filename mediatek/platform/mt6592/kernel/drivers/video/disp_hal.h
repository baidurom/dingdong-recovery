...
#if 0
void disphal_fbconfig_dsi_late_prepare(void);
int disphal_fbconfig_mipi_clk_set(unsigned int clk);
void disphal_fbconfig_dsi_post(void);
void disphal_fbconfig_mipi_lane_set(unsigned int lane_num);
void disphal_fbconfig_mipi_timing_set(MIPI_TIMING timing);
void disphal_fbconfig_disp_set_te_enable(char enable);
void disphal_fbconfig_disp_set_continuous_clock(int enable);
#endif
typedef struct
{    
