...
#else
#define FILELIST_SA 0xA0000000//0x05000000 //0x08000000
#endif
...
#define CONFIG_CHIP_VER_CURR  100
...
#define MT6582_L2_EMULATION 2 // 0: No L2$ emulation, 1: L2$ emulation with DRAM, 2: Use L2$ for VLD & PP Wrapper
