...
#else
char _ESAFileName[2][100] = {"/storage/sdcard1/ESA_LOG.csv\0","/mnt/udiska/ESA_LOG1.csv\0"};
#endif
#endif

#ifdef REG_LOG_NEW
char _RegFileName[2][100] = {"/storage/sdcard1/RegDump.txt\0","D:\\Sandbox\\RegDump.txt\0"};
#endif
...
#else
char _FileList_Rec[2][100]= {"/storage/sdcard1/h264.list","/mnt/udiska/VDec1_filelist_rec.txt"};
#endif
...
#else
char _FileList[2][100]= {"/storage/sdcard1/h264.list\0", "/mnt/udiska/8320_ver_list.txt\0"};
#endif
