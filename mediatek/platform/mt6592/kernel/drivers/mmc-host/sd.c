...
//liguowei@wind-mobi.com 20131031 begin			
#ifdef CONFIG_VMCH_POWERON_ALLTIME	
			msdc_ldo_power(KAL_TRUE, MT6323_POWER_LDO_VMCH, VOL_3300, &g_msdc1_flash);//hzs
#else			
			msdc_ldo_power(on, MT6323_POWER_LDO_VMCH, VOL_3300, &g_msdc1_flash);
#endif
//liguowei@wind-mobi.com 20131031 end
			}
			//msdc_set_enio18(host,0);
