 ...
 ******************************************************************************/
 ...
 #define TS_CON0             (APMIXEDSYS_BASE + 0x600)
 #define TS_CON1             (APMIXEDSYS_BASE + 0x604)
 #define TS_CON0_P           (IO_VIRT_TO_PHYS(APMIXEDSYS_BASE) + 0x600)
 #define TS_CON1_P           (IO_VIRT_TO_PHYS(APMIXEDSYS_BASE) + 0x604)
