...
static void PTP_set_ptp_volt(void)
{
    ...
    if (freq_0 != 0)
    {
        ptpod_pmic_volt[0] = ptp_volt_0;
        ptp_array_size++;
    }

    if (freq_1 != 0)
    {
        ptpod_pmic_volt[1] = ptp_volt_1;
        ptp_array_size++;
    }

    if (freq_2 != 0)
    {
        ptpod_pmic_volt[2] = ptp_volt_2;
        ptp_array_size++;
    }

    if (freq_3 != 0)
    {
        ptpod_pmic_volt[3] = ptp_volt_3;
        ptp_array_size++;
    }

    if (freq_4 != 0)
    {
        ptpod_pmic_volt[4] = ptp_volt_4;
        ptp_array_size++;
    }

    if (freq_5 != 0)
    {
        ptpod_pmic_volt[5] = ptp_volt_5;
        ptp_array_size++;
    }

    if (freq_6 != 0)
    {
        ptpod_pmic_volt[6] = ptp_volt_6;
        ptp_array_size++;
    }

    if (freq_7 != 0)
    {
        ptpod_pmic_volt[7] = ptp_volt_7;
        ptp_array_size++;
    }
