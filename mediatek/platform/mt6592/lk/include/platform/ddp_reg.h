...
#define DISPSYS_OVL_BASE        DISP_OVL_BASE
#define DISPSYS_WDMA0_BASE      DISP_WDMA_BASE
#define DISPSYS_RDMA1_BASE      DISP_RDMA_BASE
#define DISPSYS_BLS_BASE        DISP_BLS_BASE
#define DISPSYS_COLOR_BASE      DISP_COLOR_BASE
#define DISPSYS_DBI_BASE        LCD_BASE
#define DISPSYS_DSI_BASE        DSI_BASE
#define DISPSYS_DPI0_BASE       DPI_BASE
...
//-----------------------------------------------------------------
// RDMA
#define DISP_REG_RDMA_INT_ENABLE          (DISPSYS_RDMA1_BASE + 0x0000)
#define DISP_REG_RDMA_INT_STATUS          (DISPSYS_RDMA1_BASE + 0x0004)
#define DISP_REG_RDMA_GLOBAL_CON          (DISPSYS_RDMA1_BASE + 0x0010)
#define DISP_REG_RDMA_SIZE_CON_0          (DISPSYS_RDMA1_BASE + 0x0014)
#define DISP_REG_RDMA_SIZE_CON_1          (DISPSYS_RDMA1_BASE + 0x0018)
#define DISP_REG_RDMA_MEM_CON             (DISPSYS_RDMA1_BASE + 0x0024)
#define DISP_REG_RDMA_MEM_START_ADDR      (DISPSYS_RDMA1_BASE + 0x0028)
#define DISP_REG_RDMA_MEM_SRC_PITCH       (DISPSYS_RDMA1_BASE + 0x002C)
#define DISP_REG_RDMA_MEM_GMC_SETTING_0   (DISPSYS_RDMA1_BASE + 0x0030)
#define DISP_REG_RDMA_MEM_SLOW_CON        (DISPSYS_RDMA1_BASE + 0x0034)
#define DISP_REG_RDMA_MEM_GMC_SETTING_1   (DISPSYS_RDMA1_BASE + 0x0038)
#define DISP_REG_RDMA_FIFO_CON            (DISPSYS_RDMA1_BASE + 0x0040)
#define DISP_REG_RDMA_CF_00               (DISPSYS_RDMA1_BASE + 0x0054)
#define DISP_REG_RDMA_CF_01               (DISPSYS_RDMA1_BASE + 0x0058)
#define DISP_REG_RDMA_CF_02               (DISPSYS_RDMA1_BASE + 0x005C)
#define DISP_REG_RDMA_CF_10               (DISPSYS_RDMA1_BASE + 0x0060)
#define DISP_REG_RDMA_CF_11               (DISPSYS_RDMA1_BASE + 0x0064)
#define DISP_REG_RDMA_CF_12               (DISPSYS_RDMA1_BASE + 0x0068)
#define DISP_REG_RDMA_CF_20               (DISPSYS_RDMA1_BASE + 0x006C)
#define DISP_REG_RDMA_CF_21               (DISPSYS_RDMA1_BASE + 0x0070)
#define DISP_REG_RDMA_CF_22               (DISPSYS_RDMA1_BASE + 0x0074)
#define DISP_REG_RDMA_CF_PRE_ADD0         (DISPSYS_RDMA1_BASE + 0x0078)
#define DISP_REG_RDMA_CF_PRE_ADD1         (DISPSYS_RDMA1_BASE + 0x007C)
#define DISP_REG_RDMA_CF_PRE_ADD2         (DISPSYS_RDMA1_BASE + 0x0080)
#define DISP_REG_RDMA_CF_POST_ADD0        (DISPSYS_RDMA1_BASE + 0x0084)
#define DISP_REG_RDMA_CF_POST_ADD1        (DISPSYS_RDMA1_BASE + 0x0088)
#define DISP_REG_RDMA_CF_POST_ADD2        (DISPSYS_RDMA1_BASE + 0x008C)
#define DISP_REG_RDMA_DUMMY               (DISPSYS_RDMA1_BASE + 0x0090)
#define DISP_REG_RDMA_DEBUG_OUT_SEL       (DISPSYS_RDMA1_BASE + 0x0094)
