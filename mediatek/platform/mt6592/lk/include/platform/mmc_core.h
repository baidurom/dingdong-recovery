...
extern int mmc_block_read(int dev_num, unsigned long blknr, u32 blkcnt, unsigned long *dst, u32 part_id);
extern int mmc_block_write(int dev_num, unsigned long blknr, u32 blkcnt, unsigned long *src, u32 part_id);
...
extern int mmc_read(u32 src, u8 *dst, int size);
extern int mmc_write(u8 *src, u32 dst, int size);
