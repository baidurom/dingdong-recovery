...
#define CLK_CFG_5       ((UINT32P)(CKSYS_BASE+0x090))
#define CLK_CFG_5_SET   ((UINT32P)(CKSYS_BASE+0x094))
#define CLK_CFG_5_CLR   ((UINT32P)(CKSYS_BASE+0x098))
...
// --------------------------------------------------
	...
	*((UINT32P) (0x10006298)) = 0x00000f16;	//PQ MTCOMS 
	*((UINT32P) (0x10006298)) = 0x00000f1e;	//PQ MTCOMS

	udelay(10);
        pwr_ack_status = (*SLEEP_PWR_STA & 0x00200000) >> 21;    //[21]
        pwr_acks_status = (*SLEEP_PWR_STAS & 0x00200000) >> 21;  //[21]
	if ((pwr_ack_status != 0x01) | (pwr_acks_status != 0x01)) {
		/* TINFO="Wait for Power On PQ ..." */
		printf("Power Up PQ fail %d\n", __LINE__);
		ret = -1;
	}
	*((UINT32P) (0x10006298)) = 0x00000f0e;	//PQ MTCOMS
	*((UINT32P) (0x10006298)) = 0x00000f0c;	//PQ MTCOMS
	*((UINT32P) (0x10006298)) = 0x00000f0d;	//PQ MTCOMS
	*((UINT32P) (0x10006298)) = 0x00000e0d;	//PQ MTCOMS
	*((UINT32P) (0x10006298)) = 0x00000c0d;	//PQ MTCOMS
	*((UINT32P) (0x10006298)) = 0x0000080d;	//PQ MTCOMS
	*((UINT32P) (0x10006298)) = 0x0000000d;	//PQ MTCOM
        *((UINT32P) (0x100062b8)) = 0x0; //PQ MTCOMS ADD by henry for debug
        *((UINT32P) (0x10006254)) = 0x0; //PQ MTCOMS ADD by henny for debug
...
//enable MD PLL
	...
	*((UINT32P) (0x20120104)) = 0x206;	//analog add for stable
	*((UINT32P) (0x2012014c)) = 0x00002400;	//before enable, set whpll fra to 491.15625
	*((UINT32P) (0x20120148)) = 0x0000804B;	//before enable, set whpll int to 491.15625
...
//clock enable
	/* TINFO="clock enable" */
	*((UINT32P) (0x17000000)) = 0x00000000;	//turn PQ clock
	*((UINT32P) (0x17000010)) = 0x00000007;	//turn off dcm
	*((UINT32P) (0x17000020)) = 0x00000000;	//turn off sw rst
...
//set mbist_rstb & rp_rstb
	...
	*((UINT32P) (0x17000050)) = 0x00000000;	// [0]  PQ rp_rstb=0
	*((UINT32P) (0x17000040)) = 0x00000000;	// [16] PQ mbist_rstb
	*((UINT32P) (0x13000190)) = 0x00000000;	// [0] mfg rp_rstb=0
	*((UINT32P) (0x130000a0)) = 0x00000000;	// set mfgsys mbist_rstb, [31]:mbist_rstb
...
//release mbist_rstb & rp_rstb
	...
	*((UINT32P) (0x17000050)) = 0x00000001;	// [0]  PQ rp_rstb=0
	*((UINT32P) (0x17000040)) = 0x00010000;	// [16] PQ mbist_rstb
	*((UINT32P) (0x13000190)) = 0x00000001;	// [0] mfg rp_rstb=1
	*((UINT32P) (0x130000a0)) = 0x80000000;	// release mfgsys mbist_rstb, [31]:mbist_rstb
...
//set mbist_mode=1
	...
	*((UINT32P) (0x17000038)) = 0x0000007f;	// PQ [6:0]
	*((UINT32P) (0x130000a0)) = 0x80000018;	// [4:3] mbist_mode, [31]: mbist_rstb  mfg
	*((UINT32P) (0x14000810)) = 0x00000040;	// [6] mbist_mode  mm
	*((UINT32P) (0x15000074)) = 0x0000e000;	// [15:13] mbist_mode  img 
if( (*((UINT32P) (0x10206040)) & 0x00400000) == 0x0) {     //MD efuse not disable
...
/* TINFO="PQ mbist_done" */
	if ((*((UINT32P) (0x17000024)) & 0x007f) != 0x007f) {	//PQ mbist_done
		printf("PQ mbist_done is not ready %d\n", __LINE__);
		ret = -1;
	}

/* TINFO="mfg mbist_done" */
	if (((*((UINT32P) (0x130000d0)) & 0xfff00000) != 0xfff00000) &&
            ((*((UINT32P) (0x130000d4)) & 0x000fffff) != 0x000fffff)) {	//mfg mbist_done
...
/* TINFO="img mbist_done" */
	if ((*((UINT32P) (0x15000038)) & 0xe100) != 0xe100) {	//img mbist_done
...
// ------------------------------------------------------------------
	...
	*((UINT32P) (0x17000038)) = 0x00000000;	// PQ [6:0]
	*((UINT32P) (0x130000a0)) = 0x00000000;	// [1] mbist_mode, [31]: mbist_rstb  mfg
...
if( (*((UINT32P) (0x10206040)) & 0x00400000) == 0x0) {     //MD efuse not disable
        *((UINT32P) (0x23008040)) = 0x00000000; // set modemsys mbist_rstb, [0]: mbist_rstb
	*((UINT32P) (0x200e0044)) = 0x00000000;	// release mdsys mbist_rstb, [0]: mbist_rstb, [1]:repair reset [2]:reg_load_fuse
    if( (*((UINT32P) (0x10206044)) & 0x00000001) == 0x0) {   //HSPA efuse not disable
	*((UINT32P) (0x236e007c)) = 0x00000000;	// set hspa3sys mbist_rst, [0]: mbist_rstbb
    }
    if( (*((UINT32P) (0x10206044)) & 0x00000080) == 0x0) {   //TDD efuse not disable
...
//set mbist_mode=1
	...
	*((UINT32P) (0x130000a0)) = 0x80000018;	// [4:3] mbist_mode, [31]: mbist_rstb  mfg
	*((UINT32P) (0x14000810)) = 0x00000040;	// [6] mbist_mode  mm
	*((UINT32P) (0x15000074)) = 0x0000e000;	// [15:12] mbist_mode  img 
if( (*((UINT32P) (0x10206040)) & 0x00400000) == 0x0) {     //MD efuse not disable
	*((UINT32P) (0x200e0000)) = 0x00000ff6;	// [11:4,2:1] mbist_mode  md
    if( (*((UINT32P) (0x10206044)) & 0x00000001) == 0x0) {   //HSPA efuse not disable
	*((UINT32P) (0x236e0000)) = 0x00000080;	// [7] mbist_mode  md_hspa3
...
// ------------------------------------------------------------------
	/* TINFO="check mbist_fail" */
	/* TINFO="PQ mbist_fail" */
	if ((*((UINT32P) (0x17000028)) & 0xffffffff) ||
	    (*((UINT32P) (0x1700002c)) & 0x00ffffff) ){	// []: mfgsys mbist_fail
		printf("PQ sram fail %d\n", __LINE__);
		ret = -1;
	}
	/* TINFO="mfg mbist_fail" */
	if (((*((UINT32P) (0x13000100)) & 0xfff00000)) ||
            ((*((UINT32P) (0x13000104)) & 0x000fffff)))  {	// [18:3]: mfgsys mbist_fail
		printf("mfgsys sram fail %d\n", __LINE__);
		ret = -1;
	}
	/* TINFO="mm mbist_fail" */
	...
	/* TINFO="img mbist_fail"     
	   [31:26]: img mbist_fail
	   [40, 37, 34:32]: mbist_fail */
	if (((*((UINT32P) (0x15000048)) & 0x8000000)) 
	    || ((*((UINT32P) (0x1500004c)) & 0x00000cff))) {
		printf("img sram fail %d\n", __LINE__);
		ret = -1;
	}
...
// ------------------------------------------------------------------
	...
	*((UINT32P) (0x17000038)) = 0x00000000;	// [1] mbist_mode, [31]: mbist_rstb  mfg
	*((UINT32P) (0x130000a0)) = 0x00000000;	// [1] mbist_mode, [31]: mbist_rstb  mfg
	*((UINT32P) (0x14000810)) = 0x00000000;	// [6] mbist_mode  mm
	*((UINT32P) (0x15000074)) = 0x00000000;	// [12:10] mbist_mode  img 
if( (*((UINT32P) (0x10206040)) & 0x00400000) == 0x0) {     //MD efuse not disable
...
// ------------------------------------------------------------------
	...
	*CLK_CFG_5 = rdata_cksw5 & 0x1F1F1F1F;
	udelay(1);
	if (((*CKSTA_REG) & 0xffffffff) != 0x0) {
	...
	*CLK_CFG_5_SET = rdata_cksw5 & 0x80808080;
...
//*((UINT32P)(0x15004150)) = 0x0;//turn img clock
	...
	*((UINT32P) (0x10006238)) = 0x00000f12;	//ISP MTCOMS
        ...
        *((UINT32P) (0x100062b8)) = 0x0000007f; //PQ MTCOMS ADD by henry for debug
        *((UINT32P) (0x10006254)) = 0x00000001; //PQ MTCOMS ADD by henny for debug
	*((UINT32P) (0x10006298)) = 0x0000010d;	//PQ MTCOMS 
	*((UINT32P) (0x10006298)) = 0x0000030d;	//PQ MTCOMS
	*((UINT32P) (0x10006298)) = 0x0000070d;	//PQ MTCOMS
	*((UINT32P) (0x10006298)) = 0x00000f0d;	//PQ MTCOMS
	*((UINT32P) (0x10006298)) = 0x00000f0f;	//PQ MTCOMS
	*((UINT32P) (0x10006298)) = 0x00000f1e;	//PQ MTCOMS
	*((UINT32P) (0x10006298)) = 0x00000f1a;	//PQ MTCOMS
	*((UINT32P) (0x10006298)) = 0x00000f12;	//PQ MTCOMS
