...
static int mboot_android_check_bootimg_hdr(part_dev_t *dev, char *part_name, boot_img_hdr *boot_hdr)
{
    ...
    dprintf(CRITICAL,"part page addr is 0x%x\n",(unsigned int) addr);
...
static int mboot_android_check_recoveryimg_hdr(part_dev_t *dev, char *part_name, boot_img_hdr *boot_hdr)
{
    ...
    dprintf(CRITICAL,"[%s] Android Recovery IMG Hdr - Kernel Size 	: 0x%x\n",MODULE_NAME,boot_hdr->kernel_size);
    dprintf(CRITICAL,"[%s] Android Recovery IMG Hdr - Rootfs Size 	: 0x%x\n",MODULE_NAME,boot_hdr->ramdisk_size);
    dprintf(CRITICAL,"[%s] Android Recovery IMG Hdr - Page Size    	: 0x%x\n",MODULE_NAME,boot_hdr->page_size);    
	dprintf(CRITICAL,"============================================================\n");
...
static int mboot_android_check_factoryimg_hdr(char *part_name, boot_img_hdr *boot_hdr)
{
 ...
 //   ulong addr;
    ...
    dprintf(CRITICAL,"[%s] Android Factory IMG Hdr - Kernel Size 	: 0x%x\n",MODULE_NAME,boot_hdr->kernel_size);
    dprintf(CRITICAL,"[%s] Android Factory IMG Hdr - Rootfs Size 	: 0x%x\n",MODULE_NAME,boot_hdr->ramdisk_size);
    dprintf(CRITICAL,"[%s] Android Factory IMG Hdr - Page Size    	: 0x%x\n",MODULE_NAME,boot_hdr->page_size);    
	dprintf(CRITICAL,"============================================================\n");
