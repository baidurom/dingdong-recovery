...
u16 gpio_init_smt_data[] = {
	...
	((GPIO_SMT_GROUP_16 << 16) |(GPIO_SMT_GROUP_17 << 17) |(GPIO_SMT_GROUP_18 << 18) |(GPIO_SMT_GROUP_19 << 19) |
	 (GPIO_SMT_GROUP_20 << 20) |(GPIO_SMT_GROUP_21 << 21) |(GPIO_SMT_GROUP_22 << 22) |(GPIO_SMT_GROUP_23 << 23) |
	 (GPIO_SMT_GROUP_24 << 24))
};
/*----------------------------------------------------------------------------*/
