...
#include "AudioMTKStreamManager.h" //HP switch
#include "AudioMTKStreamManagerInterface.h" //HP switch
...
class AudioResourceManager : public AudioResourceManagerInterface
{
    ...
    private:
        ...
        AudioMTKStreamManagerInterface *mAudioMTKStreamManager; //HP switch
};
