...
status_t SpeechPhoneCallController::OpenModemSpeechDigitalPart(const modem_index_t modem_index, const audio_devices_t output_device)
{
	...
	{
		ALOGD("OpenModemSpeechDigitalPart() AudioDigitalType::I2S_OUT_2 using for TFA9887.");
	...
	else // Headphone & Handset
	{
		ALOGD("OpenModemSpeechDigitalPart() AudioDigitalType::I2S_OUT_DAC using for Headphone or Handset.");
...
status_t SpeechPhoneCallController::CloseModemSpeechDigitalPart(const modem_index_t modem_index, const audio_devices_t output_device)
{
	...
	if (output_device & AUDIO_DEVICE_OUT_SPEAKER)
	{
		ALOGD("CloseModemSpeechDigitalPart() AudioDigitalType::I2S_OUT_2 using for TFA9887.");
		mAudioDigitalInstance->Set2ndI2SOutEnable(false);
	...
	{
		ALOGD("CloseModemSpeechDigitalPart() AudioDigitalType::I2S_OUT_DAC using for Headphone or Handset.");
