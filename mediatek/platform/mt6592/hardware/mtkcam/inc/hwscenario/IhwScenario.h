...
public:
    ...
    virtual MBOOL       deque(MUINT32 port, vector<PortQTBufInfo> *pBufIn ) = 0;
    ...
    virtual MVOID       getHwValidSize(MUINT32 id, MUINT32 &width, MUINT32 &height, MUINT32 fps = 30) = 0;
    virtual MVOID       enableTwoRunPass2(MBOOL en) = 0;
};
