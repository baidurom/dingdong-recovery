...
//                ctl_mux_sel2 = 0xC0084108;//0x40380148;   //TEST_MDP ctl_mux_sel2 = 0x40080108;   // 0x15004078, Bin out after LSC
            ...
            //reg_4074[22][07] = 1 [6]=0
            ctl_mux_sel |=   0x00400080;   // 0x00400080 //set SGG_SEL_EN as 1 and  SGG_SEL as 2
            ctl_mux_sel &= (~0x00000040);   // 0x00400080 //set SGG_SEL_EN as 1 and  SGG_SEL as 2


            ctl_sram_mux_cfg = 0x000054F7; //SL TEST_MDP  // 407C.
            //reg_407C[28]=0
            ctl_sram_mux_cfg &= (~0x10000000);   // (!0x10000000) //set SGG_HRZ_SEL as 0
        ...
        case eScenarioID_VSS:       //video snap shot
            ...
            if(dma_en & CAM_CTL_DMA_EN_IMG2O_EN)    //cc-mode only
            {
                ...
                #else
                enable1 |= CAM_CTL_EN1_HRZ_EN;
                cdrz_in_size_w = vOutPorts[idx_img2o]->u4ImgWidth;                
                PIPE_INF("VSS-vOutPorts[idx_img2o]->u4ImgWidth:%d",vOutPorts[idx_img2o]->u4ImgWidth);
                #endif
            }
            else
            {
