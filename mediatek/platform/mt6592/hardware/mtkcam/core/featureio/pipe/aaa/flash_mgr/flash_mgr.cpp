...
#define ALG_TAG_SIZE 2312 // = 550*4 //500
#define A3_DIV_X 120
#define A3_DIV_Y 90
...
int g_eg_mfDuty=-1;
int g_eg_mfStep=-1;
static void (* g_pPostFunc)(int en);
static void (* g_pPreFunc)(int en);
//====================================================
// function
//====================================================
...
int dec2GPower(int bDec)
{
	...
	//connect socket
	int g_sock;
	g_sock = socket_local_client("rild-debug", ANDROID_SOCKET_NAMESPACE_RESERVED, SOCK_STREAM);
...
{
	LogInfo("qq state=%d",g_previewMode);
