...
LOCAL_C_INCLUDES:= \
	 ...
	 $(TOP)/$(MTK_PATH_PLATFORM)/hardware/mtkcam/inc/algorithm/libcore \
	 $(TOP)/$(MTK_PATH_PLATFORM)/hardware/mtkcam/inc/algorithm/libmav \
	 $(TOP)/$(MTK_PATH_PLATFORM)/hardware/mtkcam/inc/algorithm/libwarp \
	 $(TOP)/$(MTK_PATH_PLATFORM)/hardware/mtkcam/inc/algorithm/libmotion \
	 $(TOP)/$(MTK_PATH_PLATFORM)/hardware/mtkcam/inc/algorithm/libpano3d \
