...
protected:    //// helper function 
    ...
    MVOID         updateAPMemState(MUINT32 processed, MUINT32 free);
    MVOID         updateNativeMemState(MUINT32 jpegsize);
    MUINT32       getShotInterval(MUINT32 count, MUINT32 lastInterval); //in us
...
protected:      //// data members
    ...
    MUINT32         mu4ShotFps;
    MUINT32         mu4JpegTotalByte;
    MINT32          mi4EstimateFreeMemory;
