...
#include <camshot/ICaptureBufHandler.h>
...
)
{
    ...
    //  Arguments:
    //          N/A
    case eCmd_setCShotState:
        ret = onCmd_setCShotState(arg1,arg2);
        break;
...
bool
ContinuousShot::
onCmd_setCShotState(int32_t processed_byte, int32_t free_byte)
{
    bool ret = true;
    ...
    {
        MY_LOGD("set continuous shot process/free: %d/%d", processed_byte, free_byte);
        ret = mpMultiShot->sendCommand(NSCamShot::ECamShot_CMD_SET_CSHOT_STATE, processed_byte, free_byte, 0);
    }
