...
LOCAL_C_INCLUDES += \
    ...
    $(TOP)/$(MTK_PATH_PLATFORM)/hardware/mtkcam/custom/hal/inc/camera_feature \
    $(TOP)/$(MTK_PATH_PLATFORM)/hardware/mtkcam/custom/hal/inc/isp_tuning \
    $(TOP)/$(MTK_PATH_PLATFORM)/hardware/mtkcam/custom/hal/inc/aaa \
    $(TOP)/$(MTK_PATH_PLATFORM)/hardware/mtkcam/custom/hal/inc/aaa/debug_exif/aaa \
    $(TOP)/$(MTK_PATH_PLATFORM)/hardware/mtkcam/custom/hal/inc/aaa/debug_exif/cam \
