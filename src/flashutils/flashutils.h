...
int backup_raw_partition(const char* partitionType, const char *partition, const char *filename, int data_size);
...
extern int cmd_mmc_backup_raw_partition(const char *partition, const char *filename, int data_size);
