...
{
    //TODO
    ddProgress_show_progress(portion, seconds);
}
void ui_set_progress(float fraction) // 0.0 - 1.0 within the defined scope
{
    ddProgress_set_progress(fraction);
    //TODO
}

void ui_set_progress_info(char *str) // 0.0 - 1.0 within the defined scope
{
