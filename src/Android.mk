...
LOCAL_STATIC_LIBRARIES += libdd libcutils libbusybox
...
#end
include $(commands_recovery_local_path)/ddui/Android.mk
...
include $(commands_recovery_local_path)/busybox/Android.mk
