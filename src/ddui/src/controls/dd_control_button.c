...
ACONTROLP acbutton(
  ...
  ag_text(&d->control,txtw,txtx,txty,text,acfg()->textfg,isbig);
  ...
  //ag_textf(&d->control_pushed,txtw,txtx+1,txty+1,text,acfg()->controlbg,isbig);
  ag_text(&d->control_pushed,txtw,txtx,txty,text,acfg()->textfg,isbig);
  ...
  //ag_textf(&d->control_focused,txtw,txtx+1,txty+1,text,acfg()->controlbg,isbig);
  ag_text(&d->control_focused,txtw,txtx,txty,text,acfg()->textfg,isbig);
