 ...
 * Descriptions:
 * -------------
 * Main DD Installer HEADER
 *
 */

#ifndef __DD_INTER_H__
#define __DD_INTER_H__
...
#define ag_rgb_r(r,g,b)       ((color) ((r >> 3) << 11)| ((g >> 2) << 5)| ((b >> 3) << 0))
#define ag_rgba32_r(r,g,b,a)  ((dword)((((r)&0xff)<<24)|(((g)&0xff)<<16)|(((b)&0xff)<<8)|((a)&0xff)))
#define ag_rgb32_r(r,g,b)     ag_rgba32_r(r,g,b,0xff)
#define ag_rgba32_r(r,g,b,a)  ((dword)((((r)&0xff)<<24)|(((g)&0xff)<<16)|(((b)&0xff)<<8)|((a)&0xff)))
#define ag_rgb32_r(r,g,b)     ag_rgba32_r(r,g,b,0xff)
#define ag_a32_r(rgb)         ((byte) (rgb))
#define ag_b32_r(rgb)         ((byte) (((word) (rgb))>>8))
#define ag_g32_r(rgb)         ((byte) ((rgb) >> 16))
#define ag_r32_r(rgb)         ((byte) (((dword) (rgb))>>24))
#define ag_rgbto32_r(rgb)     (ag_rgba32_r(ag_r(rgb),ag_g(rgb),ag_b(rgb),0xff))
#define ag_rgbto16_r(rgb)     (ag_rgb_r(ag_r32(rgb),ag_g32(rgb),ag_b32(rgb)))
...
//
// DD Window Message - In DWORD (4bytes)
//
...
//
// DD Window Control Callback Typedef
//
...
//-- UI Functions
//char * dd_parsepropstring(char * buffer,char *key);
char * dd_readfromzip(char * name);
...
//
// DD Freetype Arabic & RTL Handler
//
...
CANVAS *  agc();          // Get Main DD Graph Canvas
byte      ag_init();      // Init DD Graph and Framebuffers
void      ag_close_thread(); // Close Graph Thread
void      ag_close();     // Close DD Graph and Framebuffers
...
//
// DD Canvas Manipulation Functions
//
...
//
// DD Canvas Drawing Functions
//
byte      ag_rect_block(CANVAS *_b,int x, int y, int w, int h, color cl);   // Draw Block Solid Rectangle
...
int ag_changcolor_565();
//
// DD EVENTS & Input Functions
...
//
// DD Kinetic Calculator Functions
//
...
//
// DD Window Management System Functions
//
...
byte acblockmenu_add(ACONTROLP ctl,char * title, char *title_sub, char *image);
ACONTROLP acsdmenu(
  AWINDOWP win,
  int x,
  int y,
...
//**********[ DD LOGGING ]**********//
#define _DD_DEBUG_TAG "dd"
#ifndef _DD_NODEBUG
#define LOGS(...) fprintf(stdout, _DD_DEBUG_TAG "/s: " __VA_ARGS__)
#define LOGE(...) fprintf(stdout, _DD_DEBUG_TAG "/e: " __VA_ARGS__)
#define LOGW(...) fprintf(stdout, _DD_DEBUG_TAG "/w: " __VA_ARGS__)
#define LOGI(...) fprintf(stdout, _DD_DEBUG_TAG "/i: " __VA_ARGS__)
#define LOGV(...) fprintf(stdout, _DD_DEBUG_TAG "/v: " __VA_ARGS__)
#define LOGD(...) fprintf(stdout, _DD_DEBUG_TAG "/d: " __VA_ARGS__)
#else
#define LOGS(...) fprintf(stdout, _DD_DEBUG_TAG "/s: " __VA_ARGS__)
#define LOGE(...) fprintf(stdout, _DD_DEBUG_TAG "/e: " __VA_ARGS__)
#define LOGW(...) /**/
