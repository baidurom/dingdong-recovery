...
ifeq ($(LOCAL_ALE_ENABLED),true)
    ale_target_flags := -specs=$(TOPDIR)$(MTK_ROOT_SOURCE)/external/ale/common/gcc44-specs -DHAVE_ALE_FEATURE=1
endif
...
$(LOCAL_INTERMEDIATE_TARGETS): PRIVATE_TARGET_ALE_FLAGS := $(ale_target_flags)
