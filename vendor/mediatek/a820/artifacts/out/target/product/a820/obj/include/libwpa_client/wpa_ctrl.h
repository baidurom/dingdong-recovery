...
/* CONFIG_MTK_WFD */
#define P2P_EVENT_PERSISTENT_GROUP_INVITED "P2P-PERSISTENT-GROUP-INVITED "
...
/* CONFIG_MTK_WFD */
#define WFD_EVENT_AUTO_SWITCH_ROLE "P2P-WFD-AUTO-SWITCH-ROLE "
...
extern int wpa_ctrl_randum(char *buf, size_t len);
