 ...
 *----------------------------------------------------------------------------
 * Purpose:
 * Implement Ramp Up Filter to Audio Output Buffer
 *
 * Inputs:
 *  pEASData        - buffer for internal EAS data
 *  pNumPerChannel  - sample numbers in the buffer per channel
 *
 * Outputs:
 *  EAS_SUCCESS if ramp up was successfully done
 *
 *----------------------------------------------------------------------------
*/
EAS_PUBLIC EAS_RESULT EAS_RampUp(EAS_DATA_HANDLE pEASData, EAS_U32 pNumPerChannel);
