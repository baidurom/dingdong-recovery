...
int log_property_set(const char *key, const char *value)
{
    return __system_property_set(key, value);
}

int log_property_get(const char *key, char *value, const char *default_value)
{
    int len;
...
int log_property_list(void (*propfn)(const char *key, const char *value, void *cookie),
                  void *cookie)
{
